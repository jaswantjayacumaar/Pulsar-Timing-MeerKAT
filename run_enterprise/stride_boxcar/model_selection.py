...
parser.add_argument('--glep', '--glep-range', type=float, default=50, help='The prior range for glep')
...
for gi in args.glitches:
    ...
    for exp in args.recoveries:
        ...
        sfpsr.MCMC_fit(glitchnum=gi, recoveries=exp, GLF2=args.glf2, gleprange=args.glep, glf0drange=args.glf0d, sigma=args.sigma, gltdsplit=args.split, glf2range=args.f2)
